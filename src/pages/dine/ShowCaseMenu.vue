      ...
      <div class=" ">
        <div class=" h-full text-gray-800">
          <div class="flex  flex-wrap  h-full" >
            ...
            <!--        about us section-->
            <div class="xl:ml-20 p-5 ml-24 mt-10 text-white xs:w-2/3  w-1/3 mb-12  absolute bg-black opacity-75 ">
              <h2>Our Story</h2>
          ...
          <div class="container  mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-3 xl:grid-cols-3">
              ...
              <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                <div>
                  <div class="p-3 mr-4 text-center text-orange-500  rounded-full ">
       ...
       <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        <div class="mr-10">
          <div class="w-full  mb-5 rounded-lg m-h-40 transform hover:translate-y-2 transition duration-300">
            <figure class="">
              <img src="https://images.unsplash.com/photo-1461555806864-d8b528023e7c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Zm9vZCUyMG9uJTIwd2hpdGUlMjBwbGF0ZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=1000&q=60" alt=""
            ...
            <div style="color: black" class=" p-4 flex flex-col">
              <div>
                ...
                <span class="text-xs text-white leading-none">And then there was Pro.</span>
              </div>
        ...
        <div class="mr-10">
          <div class="w-full  mb-5 rounded-lg m-h-40 transform hover:translate-y-2 transition duration-300">
            <figure class="">
              <img src="https://media.istockphoto.com/id/173632365/photo/two-eggs-over-easy-with-bacon-on-white-plate.jpg?b=1&s=170667a&w=0&k=20&c=0aLCIUnk14hSXr9eAflP3R46VOhiGyYR71kB84O7r1Q=" alt=""
                   class="h-32 w-32 menu-img" />
            </figure>
            <div style="color: black" class=" p-4 flex flex-col">
              <div>
        ...
        <div class="mr-10">
          <div class="w-full  mb-5 rounded-lg m-h-40 transform hover:translate-y-2 transition duration-300">
            <figure class="">
              <img src="https://media.istockphoto.com/id/155284180/photo/burger.jpg?b=1&s=170667a&w=0&k=20&c=jfEi17cXHDm-cAobDww6UeOz3lR1EHe9RQthDuS5oUQ=" alt=""
                   class="h-32 w-32 menu-img" />
            </figure>
            <div style="color: black" class=" p-4 flex flex-col">
              <div>
