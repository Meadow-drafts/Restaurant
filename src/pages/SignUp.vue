...
<!--        others-->
        <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
          <form>
            ...
            <form class="rounded border-2 p-7 m-10">
              <p class="text-center text-lg text-gray-100 underline">Make Your Reservation</p>
              ...
              <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-6 group">
                  ...
                  <label for="floating_company" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Table Number</label>
                </div>
              </div>
