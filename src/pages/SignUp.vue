          ...
          <form>
            ...
            <form class="rounded border-2 p-7 m-10">
              ...
              <router-link
                  ...
                  class="text-white bg-yellow-700 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
              >
                Submit</router-link
              >
            </form>
