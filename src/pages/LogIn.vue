<template>
  <!-- component -->
<div class=" element-container flex h-screen w-full items-center justify-center "
>
<div class="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
  <div class="text-white">
    <div class="mb-8 flex flex-col items-center">
      ...
      <h1 class="mb-2 font-bold text-5xl text-green-500" style="font-family: cursive;">Welcome  !</h1>
      <span class="text-gray-300">Fill in your details</span>
    </div>
    <div>
      ...
      <div class="mt-8 flex flex-col justify-center border-t-2 border-white p-2 text-lg text-black">
        <button  v-if="!isLoading" @click="clickLogin" 
        type="submit" 
