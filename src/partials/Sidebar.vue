    ...
    >
      ...
      <div class="space-y-8">
        ...
        <div>
          ...
          <ul class="mt-3">
            <!-- Dashboard -->
            <router-link to="/" v-slot="parentLink" :activeCondition="currentRoute.fullPath === '/' || currentRoute.fullPath.includes('dashboard')">
              ...
              <!-- sign up -->
            <router-link to="/sign-up" custom v-slot="{ href, navigate }">
              <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0">
                <a class="block text-slate-200 hover:text-white truncate transition duration-150"  @click="navigate">
                  <div class="flex items-center">
                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              <!-- coffe shop -->
            <router-link to="/hero" custom v-slot="{ href, navigate }">
              <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0">
                <a class="block text-slate-200 hover:text-white truncate transition duration-150"  @click="navigate">
                  <div class="flex items-center">
                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Coffee Shop</span>
                  </div>
                </a>
              </li>
            </router-link>
               <!-- Dine -->
            <router-link to="/dine" custom v-slot="{ href, navigate }">
              <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0">
                <a class="block text-slate-200 hover:text-white truncate transition duration-150"  @click="navigate">
                  <div class="flex items-center">
                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Restaurant</span>
                  </div>
                </a>
              </li>
            </router-link>
